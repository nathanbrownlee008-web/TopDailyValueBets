...
(function(){
  ...
  window.buildTrackerGroupedHTML = function(rows){
    ...
    months.forEach((monthEntry, monthIndex)=>{
      ...
      const monthOpen = Object.prototype.hasOwnProperty.call(monthState, monthKey) ? !!monthState[monthKey] : isCurrentMonth;
      ...
      Array.from(monthEntry.weeks.entries()).forEach(([weekLabel, weekEntry], weekIndex)=>{
        ...
        const weekOpen = Object.prototype.hasOwnProperty.call(weekState, weekKey) ? !!weekState[weekKey] : isCurrentWeek;
        ...
        Array.from(weekEntry.days.entries()).forEach(([dayLabel, dayRows], dayIndex)=>{
          ...
          const dayOpen = Object.prototype.hasOwnProperty.call(dayState, dayKey) ? !!dayState[dayKey] : isCurrentDay;
