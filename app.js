...
function __renderBet(row){
    ...
    const pClass = p > 0 ? "profit-win" : (p < 0 ? "profit-loss" : "");
    return `
      <div class="tracker-grid-card tracker-grid-card--final">
        <div class="tracker-grid-topbar">
          <div class="tracker-grid-match">${__trEsc(row.match || "")}</div>
          <div class="tracker-grid-result tracker-grid-result--top">
        ...
        <div class="tracker-grid-meta tracker-grid-meta--final">
          <div class="tracker-grid-market-slot">
            <span>Market</span>
            <div class="tracker-grid-market-inline">${__trEsc(row.market || "—")}</div>
          </div>
          <div>
            <span>Stake</span>
