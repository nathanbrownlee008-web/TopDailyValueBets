...
(function(){
  ...
  async function forceVipPreview(){
    if(vipPreviewLoaded || vipPreviewLoading) return;
    ...
    try{
      ...
      if(typeof Chart !== 'undefined'){
        ...
        vipPreviewChartOverride = new Chart(ctx, {
          type:'line',
          data:{
            labels,
            datasets:[{
      ...
      vipPreviewLoading = false;
    }
  }

  if(document.readyState === 'loading'){
    document.addEventListener('DOMContentLoaded', ()=>{ setTimeout(forceVipPreview, 500); }, { once:true });
  }else{
    setTimeout(forceVipPreview, 500);
  }
})();
