            ...
            <div class="tracker-grid-card">
              ...
              <div class="tracker-grid-meta tracker-grid-meta--single-row">
                <div class="tracker-grid-market-slot">
                  <span>Market</span>
                  <div class="tracker-grid-market-inline"><span class="tracker-market-emoji">${trackerEsc(getMarketIcon(row.market) || "📊")}</span><span class="tracker-market-label">${trackerEsc(row.market || "—")}</span></div>
                </div>
                <div>
                  <span>Stake</span>
