...
function renderBookieValueBet(bookie = "") {
  ...
  if (!logo) {
    return `<div class="bet-bookie-row"><span class="bet-bookie-text">${clean}</span></div>`;
  }

  return `<div class="bet-bookie-row">
    <img class="bet-bookie-logo ${darkLogo ? "bet-bookie-logo--dark" : ""}"
         src="${logo}"
         alt="${clean}"
