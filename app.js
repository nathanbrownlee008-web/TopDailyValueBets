...
const tabHistoryEl = null;
const historySectionEl = null;
const historyDaySelectEl = null;
...
const historySummaryEl = null;
const historyRefreshEl = null;

let currentTopTab = "bets"; // 'bets' | 'tracker' | 'tdt'
