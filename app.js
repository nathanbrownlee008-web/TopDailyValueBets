...
/* ===== VIP BUTTON + STATE RESYNC SAFE PATCH ===== */
(function(){
  ...
  checkVIP = async function(){
    ...
    const promoEl = document.getElementById('vipPromo');
    if(promoEl) promoEl.style.display = active ? 'none' : '';
    try{ if(typeof loadBets === 'function') await loadBets(); }catch(e){}
    bindVipButtonsSafe();
    return active;
  };

  bindVipButtonsSafe();
  setTimeout(bindVipButtonsSafe, 250);
})();
/* ===== END VIP BUTTON + STATE RESYNC SAFE PATCH ===== */
